...
export const MODEL_REGISTRY: Record<1 | 2, ModelConfig[]> = {
  // Tier 1: Cost-effective models via Fireworks — specialized functions
  1: [
    {
      ...
      tier: 1,
      provider: 'fireworks',
      purpose: "Simple chat, basic Q&A, casual conversation, quick responses",
      inPerM: 0.15,
      outPerM: 0.15,
      estimatedLatency: 600,
      maxTokens: 8192,
      capabilities: ["chat", "basic-qa", "casual-conversation"],
    ...
    },
    {
      ...
      tier: 1,
      provider: 'fireworks',
      purpose: "General chat, summarization, translation, text classification",
      inPerM: 0.10,
      outPerM: 0.10,
      estimatedLatency: 500,
      maxTokens: 8192,
      capabilities: ["chat", "summarization", "translation", "classification"],
      specialization: 'general',
    },
    {
      ...
      tier: 1,
      provider: 'fireworks',
      purpose: "Information extraction, entity recognition, text analysis",
      inPerM: 0.08,
      outPerM: 0.08,
      estimatedLatency: 450,
      maxTokens: 4096,
      capabilities: ["extraction", "ner", "text-analysis"],
      specialization: 'general',
    },
    {
      ...
      tier: 1,
      provider: 'fireworks',
      purpose: "Sentiment analysis, content moderation, basic classification",
      inPerM: 0.07,
      outPerM: 0.07,
      estimatedLatency: 400,
      maxTokens: 8192,
      capabilities: ["sentiment", "classification", "moderation"],
      specialization: 'general',
    },
    {
      ...
      tier: 1,
      provider: 'fireworks',
      purpose: "Creative writing, storytelling, content generation",
      inPerM: 0.09,
      outPerM: 0.09,
    ...
    },
    {
      ...
      maxTokens: 128000,
      capabilities: ["long-context", "document-analysis", "code-review"],
      specialization: 'general',
    },
  ],
  // Tier 2: High-performance models via Fireworks — specialized functions
  2: [
    {
      ...
      tier: 2,
      provider: 'fireworks',
      purpose: "Complex reasoning, multi-step analysis, expert consultation",
      inPerM: 0.50,
      outPerM: 1.50,
      estimatedLatency: 1200,
      maxTokens: 16384,
      capabilities: ["complex-reasoning", "multi-step-analysis", "expert-consultation"],
      specialization: 'reasoning',
    },
    {
      ...
      tier: 2,
      provider: 'fireworks',
      purpose: "General complex tasks, research assistance, detailed explanations",
      inPerM: 0.70,
      outPerM: 0.70,
      estimatedLatency: 1500,
      maxTokens: 8192,
      capabilities: ["research", "detailed-explanations", "complex-tasks"],
      specialization: 'general',
    },
    {
      ...
      tier: 2,
      provider: 'fireworks',
      purpose: "Multi-task processing, parallel reasoning, complex workflows",
      inPerM: 0.40,
      outPerM: 0.40,
      estimatedLatency: 1000,
      maxTokens: 32768,
      capabilities: ["multi-task", "parallel-reasoning", "complex-workflows"],
      specialization: 'general',
    },
    {
      ...
      tier: 2,
      provider: 'fireworks',
      purpose: "Mathematical reasoning, scientific calculations, complex problem solving",
      inPerM: 0.60,
      outPerM: 0.60,
      estimatedLatency: 1300,
      maxTokens: 64000,
      capabilities: ["math", "scientific-reasoning", "complex-problem-solving"],
      specialization: 'math',
    },
    {
      ...
      tier: 2,
      provider: 'fireworks',
      purpose: "Advanced reasoning, strategic planning, decision support",
      inPerM: 0.65,
      outPerM: 0.65,
      estimatedLatency: 1400,
      maxTokens: 32768,
      capabilities: ["advanced-reasoning", "strategic-planning", "decision-support"],
      specialization: 'reasoning',
    },
    {
      ...
      tier: 2,
      provider: 'fireworks',
      purpose: "Code generation, debugging, code review, technical documentation",
      inPerM: 0.35,
      outPerM: 0.35,
    ...
    },
    {
      ...
      tier: 2,
      provider: 'fireworks',
      purpose: "Data analysis, pattern recognition, complex classification",
      inPerM: 0.45,
      outPerM: 0.45,
      estimatedLatency: 1100,
      maxTokens: 8192,
      capabilities: ["data-analysis", "pattern-recognition", "complex-classification"],
      specialization: 'general',
    },
  ],
}
